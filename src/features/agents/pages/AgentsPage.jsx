...
function AgentsPage() {
  ...
  const submit = async (event) => {
    ...
    if (!/^\d{6}$/.test(form.pin)) { notify("PIN aynan 6 ta raqamdan iborat bo‘lsin", "warning"); return; }
    setBusy(true);
    try {
