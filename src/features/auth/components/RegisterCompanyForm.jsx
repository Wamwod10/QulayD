  ...
  return (
    <form className="qp-auth-form" onSubmit={submit}>
      ...
      {step === 1 ? <>
        ...
        <div className="qp-auth-demo"><UserRound size={14}/> Xodimlarni keyin Ega boshqaruv panelidan qo‘shasiz. Ular Qulay’ga login qilmaydi va operatsiyalarda mas’ul shaxs sifatida ishlatiladi.</div>
      </>}
