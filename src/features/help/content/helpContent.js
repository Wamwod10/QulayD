export const HELP_CATEGORIES = [
  {
    ...
    articles: [
      { id:"first-setup", title:"Birinchi sozlash", summary:"Kompaniya, ombor, til va modullarni tayyorlash.", steps:[{title:"Kompaniya sozlamalarini oching",path:"/settings/general",pathLabel:"Sozlamalar → Umumiy"},{title:"Asosiy omborni tekshiring",path:"/warehouses",pathLabel:"Ombor → Omborlar"},{title:"Til va valyutani tanlang",path:"/settings/locale",pathLabel:"Sozlamalar → Til va hudud"},{title:"Kerakli modullarni yoqing",path:"/settings/modules",pathLabel:"Sozlamalar → Modullar"}], body:["Owner va Admin xodimlarga platforma modullarini alohida biriktirishi mumkin."] },
      { id:"first-product", title:"Birinchi mahsulot", summary:"Omborga mahsulot va boshlang‘ich qoldiq qo‘shish.", steps:[{title:"Mahsulotlar bo‘limini oching",path:"/inventory/products",pathLabel:"Ombor → Mahsulotlar"},{title:"Yangi mahsulotni bosing",path:"/inventory/products",pathLabel:"+ Mahsulot"},{title:"Ombor va boshlang‘ich qoldiqni kiriting",path:"/inventory",pathLabel:"Ombor → Qoldiqlar"}] },
      { id:"first-employee", title:"Xodim qo‘shish", summary:"Xodim hisobi va modul ruxsatlarini yaratish.", steps:[{title:"Xodimlar bo‘limini oching",path:"/users",pathLabel:"Sozlamalar → Xodimlar"},{title:"Xodim qo‘shishni bosing",path:"/users",pathLabel:"+ Xodim qo‘shish"},{title:"Login, PIN va modullarni kiriting",path:"/users",pathLabel:"Xodim formasi"}], body:["Xodim login va parol yoki PIN bilan kiradi va faqat biriktirilgan modullarni ko‘radi."] },
    ],
  },
  {
