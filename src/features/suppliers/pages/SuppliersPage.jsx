...
function SuppliersPage() {
  ...
  return <>
    <SmartTablePage title="Yetkazib beruvchilar" description="Kirim va kelajakdagi xarid moduli foydalanadigan yetkazib beruvchilar bazasi." eyebrow="Hamkorlar" rows={suppliers} searchFields={["name", "phone", "contact"]} actions={can(PERMISSIONS.CUSTOMERS_CREATE) ? <PrimaryButton onClick={() => { setForm(emptyForm); setOpen(true); }}><Plus size={15} /> Yetkazib beruvchi</PrimaryButton> : null} columns={[
